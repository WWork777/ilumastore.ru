...
export const metadata: Metadata = {
  title: "Новинки IQOS Iluma и Terea | Последние поступления | ilumastore",
  description:
  ...
  alternates: {
    canonical: "https://ilumastore.ru/new-products",
  },
};
